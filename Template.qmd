...
subtitle: "12.16.24 - 12.22.24 vs. 12.15.25 - 12.21.25"
theme: _brand.yml
format: html
---
...
create_plot <- function(data, title, y_limit, subtitle = "Second Week of December") {
...
TotalPlotFinal <- create_plot(FullData, "Total Pass Usage by Day of the Week", 3000)
SouthPlot <- create_plot(SouthRec, "South Rec Pass Usage by Day of the Week", 2000)
NorthPlot <- create_plot(NorthRec, "North Rec Visits by Day of the Week", 1000)
BDPlot <- create_plot(BDRec, "Bear Down Rec Pass Usage by Day of the Week", 50)
S91Plot <- create_plot(S91, "Studio 91 Pass Usage by Day of the Week", 20)
UnassignedPlot <- create_plot(Unassigned, "Unassigned Pass Usage by Day of the Week", 10) 

SenSource <- tibble(Facility = "Bear Down Building", Visits24 = "8792", Visits25 = "8972", PercentChange = "2.1")
