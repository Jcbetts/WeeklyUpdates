...
subtitle: "12.2.24 - 12.8.24 vs. 12.1.25 - 12.7.25"
theme: _brand.yml
format: html
---
...
create_plot <- function(data, title, y_limit, subtitle = "First Week of December") {
...
TotalPlotFinal <- create_plot(FullData, "Total Pass Usage by Day of the Week", 6000)
SouthPlot <- create_plot(SouthRec, "South Rec Pass Usage by Day of the Week", 4000)
NorthPlot <- create_plot(NorthRec, "North Rec Visits by Day of the Week", 1700)
BDPlot <- create_plot(BDRec, "Bear Down Rec Pass Usage by Day of the Week", 150)
S91Plot <- create_plot(S91, "Studio 91 Pass Usage by Day of the Week", 45)
UnassignedPlot <- create_plot(Unassigned, "Unassigned Pass Usage by Day of the Week", 80) 
